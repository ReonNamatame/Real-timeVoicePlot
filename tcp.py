...
class TCP:
	def __init__(self, 
		...
		if self.server_flag:
			...
			self.soc.listen(10) # accept at most 10 clients
	...
	def setTimeout(self, time_s=None):
		if self.server_flag: self.client_soc.settimeout(time_s)
		else: return

	def setBlockingMode(self, flag=True):
		if self.server_flag: self.client_soc.setblocking(flag)
		else: return